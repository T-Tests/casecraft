...
def generate_tests(file_path: str, app_type: str = None) -> str:
    ...
    # Inject overrides into config temporarily if provided
    original_app_type = _config.generation.app_type
    
    try:
        if app_type:
            _config.generation.app_type = app_type
        ...
        _config.generation.app_type = original_app_type
